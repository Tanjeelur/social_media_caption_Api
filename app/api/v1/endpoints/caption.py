...
# async def generate_caption(input_data: CaptionInput):
#     try:
#         prompt = build_prompt(input_data, platform)
...
from fastapi import APIRouter, HTTPException
from fastapi.responses import JSONResponse
from app.models.captions import CaptionInput # Assuming this path is correct
from app.services.captions_service import build_prompt_for_platform, call_gemini_api # Changed import
import re
import httpx
